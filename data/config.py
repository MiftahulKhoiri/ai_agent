...
MAX_ITER_DEFAULT = 8
REQUEST_TIMEOUT = 1200          # naik dari 300 -> 1200 detik (20 menit), sesuaikan setelah tes
TEMPERATURE = 0.2
NUM_THREAD = 4                  # RPi5 punya 4 core, pastikan semua dipakai

_DATA_DIR = os.path.dirname(os.path.abspath(__file__))
TOOL_SCHEMA_PATH = os.path.join(_DATA_DIR, "from.json")

SYSTEM_PROMPT = """Kamu adalah coding agent otonom untuk project C++/Python di Raspberry Pi.
